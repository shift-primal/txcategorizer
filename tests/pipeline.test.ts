...
import { processTransactions } from '../src/index.js';
...
describe('processTransactions (DNB end-to-end)', () => {
    ...
    it('categorizes a Vipps transfer', () => {
        const csv = dnbCsv('"10.01.2025";"Overføring Tpp: jan-fredrik";"11.01.2025";"200";"0"');
        const [tx] = processTransactions(csv, 'dnb');
    ...
    it('handles income (positive amount)', () => {
        const csv = dnbCsv('"25.01.2025";"Lønn fra Nav";"26.01.2025";"0";"30000"');
        const [tx] = processTransactions(csv, 'dnb');
    ...
    it('applies custom merchantAliases', () => {
        const csv = dnbCsv('"01.01.2025";"Visa 100121 My Custom Store";"02.01.2025";"99";"0"');
        const [tx] = processTransactions(csv, 'dnb', {
    ...
    it('applies custom categoryKeywords', () => {
        const csv = dnbCsv('"01.01.2025";"Visa 100121 Coolshop";"02.01.2025";"499";"0"');
        const [tx] = processTransactions(csv, 'dnb', {
    ...
    it('decodes ArrayBuffer content', () => {
        const csv = dnbCsv(
            '"01.01.2025";"Varekjøp 01.01 12345 KIWI 012 RAUFOSS";"02.01.2025";"150";"0"'
        );
        const buffer = new TextEncoder().encode(csv).buffer as ArrayBuffer;
        const [tx] = processTransactions(buffer, 'dnb');
        expect(tx!.merchant).toBe('Kiwi');
    });
